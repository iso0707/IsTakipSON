...
requirements = python3,kivy,plyer,fpdf2
...
android.permissions = INTERNET,POST_NOTIFICATIONS,RECEIVE_BOOT_COMPLETED,WAKE_LOCK,SCHEDULE_EXACT_ALARM,FOREGROUND_SERVICE,CAMERA,READ_MEDIA_IMAGES,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE

# (list) features (adds uses-feature -tags to manifest)
#android.features = android.hardware.usb.host
# Not: kamera özelliğini burada "gerekli" olarak işaretlemedik,
# böylece kamerası olmayan cihazlarda da uygulama kurulabilir
# (galeriden seçim yine çalışır).
